...
_Don't forget to create your .gitignore file and add .env (in both the root directory and client directory)!_
...
Now _It's a Date!_ should be accessible from [http://localhost:5173](http://localhost:5173/)
